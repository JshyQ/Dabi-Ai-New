...
async function ttsHololive(text, characterKey) {
  ...
  await axios.post("https://kit-lemonfoot-vtuber-rvc-models.hf.space/queue/join?__theme=system", payload, { headers: { 'Content-Type': 'application/json' } 
  });
...
return ttsHololive("how are you doing??", "tokinosora")
